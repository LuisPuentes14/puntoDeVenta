    ...
    public partial class FrmEntradaefectivo : Form
    {
        ...
        private void GuardarRegistro()
        {
            try
            {
                ...
                string query = "INSERT INTO entradaefectivo (codigo, usuario, valor, concepto, fecha) VALUES (@Codigo, @Usuario, @Valor, @Concepto, @Fecha)";
